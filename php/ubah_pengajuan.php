...
$sql=mysqli_query($koneksi,"SELECT * from riwayat where id_riwayat='$_GET[id_riwayat]'");
                ...
                <div class="container py-3">
                    <article>
                        <div class="container-lg" style="background-color: #e3f2fd;">
                            <h1 class="font-weight-light" style="text-align: center;">Ubah Data </h1>
                        </div>
                    </article>
                    <div class="container" style="margin-top: 35px;">
  
                        <form action="ubah_sewa.php" method="post" class="needs-validation" novalidate>
                            <div class="form-group" style="margin-top: 15px;">
                                <label for="nama_fasilitas">Fasilitas:</label>

                                <select class="form-control" id="nama_fasilitas" name="nama_fasilitas" placeholder="--- Pilih Fasilitas ---" required>
                            ...
                            <div class="form-group" style="margin-top: 15px;">
                                <label for="no_telp">Nomor Telepon:</label>
                                 <input id="no_telp" class="form-control" type="text" name="no_telp" value="<?php echo $data['no_telp'] ?>" onkeypress="return hanyaAngka(event)" required>
                                <!-- <div class="valid-feedback">Valid.</div> -->
                                <div class="invalid-feedback">Please fill out this field.</div>
                            </div>
                            <div class="form-group" style="margin-top: 15px;">
                                <label for="nama_penyewa">Nama Lengkap:</label>
                                <input type="text" value="<?php echo $data['nama_penyewa'] ?>" class="form-control" id="nama_penyewa" placeholder="" name="nama_penyewa" required>
                                <!-- <div class="valid-feedback">Valid.</div> -->
                                <div class="invalid-feedback">Please fill out this field.</div>
                            </div>
                            ...
                            <input type="date" class="form-control" value="<?php echo $data['tanggal'] ?>" id="tanggal" name="tanggal" required>
                            <div class="invalid-feedback">Please fill out this field.</div>
